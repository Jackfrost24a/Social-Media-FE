...
function HomePost({ post, pageNumber }) {
  ...
  const handleClick = (id) => {
    ...
    axios
      .post(`${API_URL}/post/homelike/${id}`, {}, headers)
      .then((res) => {
        setLiked(true);
        setLikes(likes + 1);
        console.log(res);
  ...
  const deleteHandleClick = (id) => {
    ...
    axios
      .delete(`${API_URL}/post/homeunlike/${id}`, headers)
      .then((res) => {
        setLiked(false);
        setLikes(likes - 1);
        console.log(res);
                  ...
                  <>
                    {liked ? (
                      <img
                        ...
                        alt=""
                        id="cardIcon"
                        onClick={() => deleteHandleClick(post.id)}
                      />
                    ) : (
                      <img
                        src={Heart}
