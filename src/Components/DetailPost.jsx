                ...
                <div className="box">
                  <div id="content">
                    <div className="row">
                      ...
                      <Link
                        to={`/detailprofile/${post.postData.userId}`}
                        style={{
                          cursor: "pointer",
                          textDecoration: "none",
                          color: "black",
                    ...
                    <div className="d-flex mt-2">
                      <input
                        ...
                        type="text"
                        value={commentAdd}
                        onChange={onCommentAddChange}
                        placeholder="Add comment.."
                        className="form-control rounded-0 cart-comment"
                      />
                      <span>
                        {" "}
                        <button
                          disabled={!commentAdd}
                          style={{ fontFamily: "Source Sans Pro" }}
                          onClick={() => onBtnAddCommentClick(post.postData.id)}
                          className="cart"
                        >
                          Post
                        </button>
