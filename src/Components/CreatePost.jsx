...
export class CreatePost extends Component {
  ...
  onAddImageFileChange = (e) => {
    if (e.target.files[0]) {
      this.setState({
        addImageFileName: e.target.files[0].name,
  ...
  onBtnAddPostClick = () => {
    if (this.state.addImageFile) {
      ...
      if (data.caption == "") {
        ...
        axios
          .post(API_URL + "/post/addpost", formData, headers)
          .then((res) => {
        ...
        >
          <ModalBody className="border border-white">
            <div className="text-left mr-5">
              <div
                className="pt-1 pb-1 text-right"
            ...
            <div className="text-center">
              {this.state.previewImage ? (
                ...
                <img src={Peoples44} alt="" width="300px" />
              )}
            </div>
            <div
              className="px-5 py-0"
            ...
            >
              <div className="form-group mt-3 mb-3">
                <div className="d-flex justtify-content-center">
                  <input
                    ...
                    type="file"
                    label={this.state.addImageFileName}
                    onChange={this.onAddImageFileChange}
              ...
              <div className="form-group mt-3 mb-3">
                <h3
                  ...
                  style={{ fontSize: "16px", color: "rgb(91, 1, 132)" }}
                >
                  <span className="font-weight-bold">What's on</span>
                  <span className="font-weight-light mx-2">your mind?</span>
                </h3>
                <textarea
              ...
              <div className="pt-3 pb-5">
                <button
                  ...
                  onClick={this.onBtnAddPostClick}
                  className="btn rounded w-100 d-flex justify-content-center"
                  id="my-universe-btn-uploud"
                >
