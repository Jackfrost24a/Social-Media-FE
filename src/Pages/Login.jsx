                        ...
                        <div className='row mt-4 pt-5'>
                            ...
                            <div className='col-lg-6 col-md-6 col-12'  style={{fontFamily: "Source Sans Pro"}}>
                                <div className='d-flex flex-column flex-wrap mt-5 pt-5'>
                                    <h3><span className="font-weight-bold"  style={{fontSize: '30'}}>Greetings!</span><span  style={{fontSize: '30'}} className="font-weight-light ml-1">Friends!</span></h3>
                                    <h5 className="font-weight-normal"  style={{fontSize: '14', color: 'grey'}}></h5>
                                    <div className='my-universe-form-log mt-3'>
                                        <form  className="appointment-form" id="appointment-form">
                                            ...
                                            <div className='mb-2 d-flex justify-content-center'>
                                                <Link  style={{fontFamily: "Source Sans Pro",  textDecoration: 'none'}} className="text-decoration-none" to ="/forgotpassword"> <span  style={{cursor: 'pointer', color: 'blue'}}>Forgot Password?</span></Link>
                                            </div>
                                            <div>
