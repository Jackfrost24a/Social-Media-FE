...
class Profile extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get(`${API_URL}/user/allusers`, headers)
      .then((res) => {
  ...
  onEditImageFileChange = (e) => {
    if (e.target.files[0]) {
      this.setState({
        editImageFileName: e.target.files[0].name,
  ...
  onResendEmail = () => {
    ...
    axios
      .post(
        "http://localhost:5000/user/resend",
        {},
        {
          headers: {
            Authorization: token,
  ...
  onBtnUpdatePostClick = (id) => {
    ...
    axios
      .patch(API_URL + "/user/editprofiledata", formData, headers)
      .then((res) => {
          ...
          <>
            ...
            >
              ...
              <div className="label d-flex flex-column">
                <div style={{ fontSize: "30px" }}>{item.displayname}</div>
                  ...
                  <div className="pt-4 mt-5" style={{ width: "400px" }}>
                    <div className="text-xl-left">
                      ...
                      <input
                        ...
                        className="mx-3"
                        type="file"
                        label={this.state.editImageFileName}
                        onChange={this.onEditImageFileChange}
                      />
                    </div>
                    <div>
                      <label
                      ...
                      <input
                        ...
                        onChange={this.onDisplayNameEditChange}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={this.onUsernameEditChange}
                    ...
                    <div className="d-flex" style={{ marginTop: "-10px" }}>
                      <input
                        ...
                        type="button"
                        value="Cancel"
                        onClick={() => this.setState({ selectedEditPostId: 0 })}
                      />
                      <input
                        style={{ fontFamily: "Source Sans Pro" }}
                        ...
                        type="button"
                        value="Save"
                        onClick={() => this.onBtnUpdatePostClick(item.id)}
                      />
                    </div>
                  </div>
                </div>
  ...
  render() {
    if (this.props.user.is_login) {
      return <div className="pt-3">{this.renderListPosts()}</div>;
    }
