  ...
  onSubmit = () => {
    try {
      ...
      if (
        ...
        throw { message: "Fill All Data!" };
      if (!/\S+@\S+\.\S+/.test(email))
        throw { message: "Email address is invalid" };
      if (
        !username.match("(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*]).{4,}")
      )
        throw {
          message: "Username should  contain uppercase, number, and symbol",
        };
      if (!password.match("(?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*])"))
        throw {
          message: "Password should be contain uppercase, number, and symbol",
        };
      if (password.length < 8)
        throw { message: "Password weak, please add more characters" };
      if (password !== passwordConf)
        throw { message: "Password and Confirmation Password doesnt match!" };
          ...
          <div className="pt-3">
            <div className="container pb-5">
              <div className="row mt-4 pt-5">
                ...
                <div
                  className="col-none col-md-6 col-lg-6"
                    ...
                    <div className="my-universe-form-log mt-4">
                      <form className="appointment-form" id="appointment-form">
                        ...
                        <div className="form-group my-universe-form-reg mt-1">
                          ...
                          <div
                            className="validation-alert text-muted"
                            style={{ fontSize: "10px" }}
                          >
                        ...
                        <div className="form-group my-universe-form-reg mt-1">
                          <div className="input-group d-flex flex-column">
                            <div className="d-flex my-universe-input-log">
                              <input
                                type={this.state.visibleConf.type}
                                ref={(e) => (this.passwordConf = e)}
                                placeholder="Confirmation Password"
                                className="form-control rounded-0 border-0"
                              />
                              <span
                                className="input-group-text rounded-0 border-0"
                                onClick={this.handleVisibleConf}
                                style={{
                                  cursor: "pointer",
                                  background: "none",
                                  backgroundColor: "white",
